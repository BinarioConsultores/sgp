	...
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<hr>
				<form method="POST" action="/gerente/proyecto/7/factura/1/creardetalle">
					{{ csrf_field() }}
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td width="10%">
										<input type="number" class="form-control daterange-single" name="facd_cant" id="facd_cant" onkeyup="obtenerTotal();" required="required" value="0">
									</td>
									<td width="10%">
										<input type="number" class="form-control daterange-single" name="facd_punit" id="facd_punit" onkeyup="obtenerTotal();" required="required" value="0">
									</td>
									<td width="10%">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success">Crear Detalle</button>
				</div>
			</form>
		</div>
	</div>
				...
				<form>
					...
					<div class="row">
						...
						<div class="col-md-4 form-group text-center">
							<button type="submit" class="btn btn-lg bg-green-700">Crear Factura y Agregar Detalle <i class="icon-paperplane ml-2"></i></button>
						</div>
					</div>
	            </form>
			</div>
