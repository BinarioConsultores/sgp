      ...
      series: [
         {
            name:'PRESUPUESTO UTILIZADO (S/.)',
            type: 'bar',
            data: arrEtapasxCategoriaUtilizado,
            itemStyle: {
                  normal: {
                     label: {
                        show: true,
...
var EchartsColumnsWaterfalls = function() {
    ...
    var _columnsWaterfallsExamples = function() {
        ...
        var columns_basic_element4 = document.getElementById('columns_basic4');
        ...
        if (columns_basic_element4) {

            // Initialize chart
            var columns_basic4 = echarts.init(columns_basic_element4);
            ...
            columns_basic4.setOption(JsonChart4);
        }
        ...
        var triggerChartResize = function() {
            ...
            columns_basic_element4 && columns_basic4.resize();
        };
